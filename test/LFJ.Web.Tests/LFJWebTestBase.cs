...
{
    public abstract class LFJWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LFJWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LFJWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LFJDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LFJDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LFJDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LFJDbContext, Task<T>> func)
        {
            T result;
